...
![version](https://img.shields.io/badge/version-1.16.2-brightgreen)
...
| [docs/install.md](docs/install.md) | Full operational guide: private marketplace add, auth, manual vs background updates, permissions, distribution. Most agents use bare aliases (opus / sonnet / haiku); 4 opus-tier agents are pinned to claude-opus-5-5, with override and degradation instructions. |
